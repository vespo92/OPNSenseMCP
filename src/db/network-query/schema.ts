...
export const hostnamePatterns = pgTable(
  'hostname_patterns',
  {
    id: serial('id').primaryKey(),
...
// DHCP Lease Tracking
export const dhcpLeases = pgTable(
  'dhcp_leases',
  {
    id: serial('id').primaryKey(),
...
export const activeConnections = pgTable(
  'active_connections',
  {
    id: serial('id').primaryKey(),
    deviceId: integer('device_id')
...
export const queryIntents = pgTable(
  'query_intents',
  {
    id: serial('id').primaryKey(),
...
export const queryKeywords = pgTable(
  'query_keywords',
  {
    id: serial('id').primaryKey(),
    ...
    intentId: integer('intent_id')
      .notNull()
      .references(() => queryIntents.id, { onDelete: 'cascade' }),
...
export const deviceSummaryView = pgTable(
  'device_summary_view',
  {
