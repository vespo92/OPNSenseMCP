...
export const deviceFingerprintData = [
  ...
  },
  {
    ...
    manufacturer: 'Nintendo',
    deviceType: 'gaming_console',
    commonModels: ['Nintendo 3DS', 'Wii U'],
  },
  {
    macPrefix: '00:09:BF',
    manufacturer: 'Nintendo',
    deviceType: 'gaming_console',
    commonModels: ['Nintendo Wii', 'DS'],
  },
...

  {
    ...
    deviceType: 'gaming_console',
    commonModels: ['Xbox One'],
  },
  {
    macPrefix: '60:45:BD',
    manufacturer: 'Microsoft',
    deviceType: 'gaming_console',
    commonModels: ['Xbox Series X/S'],
  },
  {
    macPrefix: '94:9A:A9',
    manufacturer: 'Microsoft',
  ...
  // Samsung Devices
  {
    ...
    deviceType: 'phone',
    commonModels: ['Galaxy S', 'Galaxy Note'],
  },
  {
    macPrefix: '40:5B:D8',
    manufacturer: 'Samsung',
    deviceType: 'phone',
    commonModels: ['Galaxy S', 'Galaxy A'],
  },
  {
    macPrefix: '8C:F5:A3',
    manufacturer: 'Samsung',
    deviceType: 'phone',
    commonModels: ['Galaxy S', 'Galaxy Z'],
  },
  {
    macPrefix: 'BC:20:BA',
    manufacturer: 'Samsung',
    deviceType: 'tablet',
    commonModels: ['Galaxy Tab'],
  },
  {
    macPrefix: 'E4:B0:21',
    manufacturer: 'Samsung',
    deviceType: 'smart_tv',
    commonModels: ['Samsung Smart TV'],
  },
  {
    macPrefix: '00:7C:2D',
    manufacturer: 'Samsung',
  ...
  // Smart Home & IoT
  {
    ...
    commonModels: ['Echo', 'Echo Dot'],
  },
  {
    macPrefix: 'A4:08:EA',
    manufacturer: 'Amazon',
    deviceType: 'smart_speaker',
    commonModels: ['Echo', 'Alexa'],
  },
  {
    macPrefix: 'FC:A1:83',
    manufacturer: 'Amazon',
    deviceType: 'smart_speaker',
    commonModels: ['Echo Show'],
  },
  {
    macPrefix: '84:D6:D0',
    manufacturer: 'Amazon',
    deviceType: 'media_player',
    commonModels: ['Fire TV'],
  },
  {
    macPrefix: '10:AE:60',
    manufacturer: 'Amazon',
    deviceType: 'media_player',
    commonModels: ['Fire TV Stick'],
  },

  {
    ...
    manufacturer: 'Google',
    deviceType: 'smart_speaker',
    commonModels: ['Google Home'],
  },
  {
    macPrefix: 'E4:F0:42',
    manufacturer: 'Google',
    deviceType: 'smart_speaker',
    commonModels: ['Google Home Mini'],
  },
  {
    macPrefix: '48:D6:D5',
    manufacturer: 'Google',
    deviceType: 'smart_speaker',
    commonModels: ['Google Nest Hub'],
  },
  {
    macPrefix: '1C:F2:9A',
    manufacturer: 'Google',
    deviceType: 'media_player',
    commonModels: ['Chromecast'],
  },
  {
    macPrefix: '6C:AD:F8',
    manufacturer: 'Google',
  ...
  // Streaming Devices
  {
    ...
    manufacturer: 'Roku',
    deviceType: 'media_player',
    commonModels: ['Roku Streaming Stick'],
  },
  {
    macPrefix: 'CC:6D:A0',
    manufacturer: 'Roku',
    deviceType: 'media_player',
    commonModels: ['Roku Ultra'],
  },
  {
    macPrefix: 'D4:E2:2F',
    manufacturer: 'Roku',
    deviceType: 'media_player',
    commonModels: ['Roku TV'],
  },
  ...
  // Smart Home Brands
  {
    ...
    commonModels: ['Kasa Smart Plug', 'Kasa Smart Switch'],
  },
  {
    macPrefix: '50:C7:BF',
    manufacturer: 'TP-Link',
    deviceType: 'smart_home',
    commonModels: ['Kasa Smart Bulb'],
  },
  {
    macPrefix: 'B4:E6:2D',
    manufacturer: 'Philips',
    deviceType: 'smart_home',
    commonModels: ['Hue Bridge', 'Hue Bulb'],
  },
  {
    macPrefix: '00:17:88',
    manufacturer: 'Philips',
  ...
  },
  {
    ...
    manufacturer: 'WeMo',
    deviceType: 'smart_home',
    commonModels: ['WeMo Switch', 'WeMo Plug'],
  },
  ...
  { macPrefix: '00:62:6E', manufacturer: 'Nest', deviceType: 'camera', commonModels: ['Nest Cam'] },
  {
    ...
    manufacturer: 'Nest',
    deviceType: 'smart_home',
    commonModels: ['Nest Thermostat'],
  },
  {
    macPrefix: '00:18:DD',
    manufacturer: 'Ring',
    deviceType: 'camera',
    commonModels: ['Ring Doorbell'],
  },
  {
    macPrefix: 'B0:09:DA',
    manufacturer: 'Ring',
    deviceType: 'camera',
    commonModels: ['Ring Camera'],
  },
  ...
  // Printers
  {
    ...
    manufacturer: 'HP',
    deviceType: 'printer',
    commonModels: ['HP Printer'],
  },
  {
    macPrefix: '00:1B:A9',
    manufacturer: 'Brother',
    deviceType: 'printer',
    commonModels: ['Brother Printer'],
  },
  {
    macPrefix: '00:00:F0',
    manufacturer: 'Canon',
    deviceType: 'printer',
    commonModels: ['Canon Printer'],
  },
  {
    macPrefix: '00:26:AB',
    manufacturer: 'Epson',
    deviceType: 'printer',
    commonModels: ['Epson Printer'],
  },
];
