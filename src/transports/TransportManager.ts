...
import type { TransportOptions, TransportType } from './types.js';
  ...
  static async createTransport(
    ...
    switch (type) {
      ...
      case 'sse':
        ...
        TransportManager.sseServer = new SSETransportServer(options);
        await TransportManager.sseServer.start();
        return TransportManager.sseServer;
